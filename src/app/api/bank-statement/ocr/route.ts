...
【お取引照合表(常陽銀行形式)の具体例】
画像が以下のような形式の場合:
| 取引日 | 勘定日 | 摘要 | 小切手番号 | お支払金額 | お預り金額 | 差引残高 |
| 7.4.1 | 7.4.1 | 振込2 | | | 30,745 | 32,194,759 |
| 7.4.2 | 7.4.2 | 口座振替 | | 230,865 | | 31,963,894 |
| 7.4.2 | 7.4.2 | 振込WB2 | | 22,000 トヨタファイナンス(カ | | 31,720,684 |

期待される出力:
{"transactions": [
  {"date": "2025-04-01", "description": "振込2", "deposit": 30745, "withdrawal": null, "balance": 32194759},
  {"date": "2025-04-02", "description": "口座振替", "deposit": null, "withdrawal": 230865, "balance": 31963894},
  {"date": "2025-04-02", "description": "振込WB2 トヨタファイナンス(カ", "deposit": null, "withdrawal": 22000, "balance": 31720684}
]}
...
取引行が1つでも見つかったら必ず transactions 配列に追加してください。
完全に空のページや、取引がない要約ページの場合のみ {"transactions": []} を返してください。`
