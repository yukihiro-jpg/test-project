                            ...
                            <div className="flex items-center justify-between flex-wrap gap-2">
                              <div className="flex items-center gap-2">
                                ...
                                {totalDeposit > 0 && (
                                  (() => {
                                    const buildingName = b.name || b.location || '建物';
                                    const isSynced = debts.some(d => d.note?.includes(`[自動連動] ${buildingName}`));
                                    return isSynced ? (
                                      <span className="text-xs text-green-700 bg-green-50 border border-green-300 rounded px-2 py-1 inline-flex items-center">
                                        <Check size={12} className="mr-1" />連動済
                                      </span>
                                    ) : (
                                      <button
                                        type="button"
